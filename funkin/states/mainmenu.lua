...
function MainMenuState:enter()
	...
	self.optionShit = {'storymode', 'freeplay', 'options'}
	...
	self.menuBg:setGraphicSize(math.floor(self.menuBg.width * 1))
	...
	self.magentaBg:setGraphicSize(math.floor(self.magentaBg.width * 1))
	...
	self.versionFormat = "FNF Circle Engine %version\nFriday Night Funkin' v0.3.0"
	self.versionText = Text(13, 0, self.versionFormat:gsub("%%version", Project.version),
		paths.getFont("vcr.ttf", 18))
	self.versionText.y = game.height - self.versionText:getHeight() - 8
	self.versionText.antialiasing = true
	self.versionText.outline.width = 0.5
